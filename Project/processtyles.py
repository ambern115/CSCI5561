...
content_path = 'TestImages/tree.jpg'
style_path = 'TestImages/berserk2.jpg'
...
# Used to view output of the opitmization
...
def run_style_transfer(content_path, 
  ...
  opt = compat.v1.train.AdamOptimizer(learning_rate=5)
  ...
  for i in range(num_iterations):
    ...
    best_l = tf.convert_to_tensor(best_loss)
    pred = tf.math.less(loss, best_l)
